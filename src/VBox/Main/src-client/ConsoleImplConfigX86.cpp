...
HRESULT Console::i_attachRawPCIDevices(PUVM pUVM, PCVMMR3VTABLE pVMM, BusAssignmentManager *pBusMgr, PCFGMNODE pDevices)
{
...
# endif
    ...
    try
    {
        ...
        if (chipsetType == ChipsetType_ICH9)
        {
            ...
            hrc = i_attachRawPCIDevices(pUVM, pVMM, pBusMgr, pDevices);                           H();
