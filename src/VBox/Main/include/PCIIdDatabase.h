...
#ifndef MAIN_INCLUDED_PCIIdDatabase_h
#define MAIN_INCLUDED_PCIIdDatabase_h
...
#define PCI_ID_DATABASE_WITH_COMPRESSION

/** Max string length. */
#define PCI_ID_DATABASE_MAX_STRING      _1K
 ...
 */
typedef struct PCIIDDBPROD
{
    /** Product ID. */
    uint16_t idProduct;
} PCIIDDBPROD;
AssertCompileSize(PCIIDDBPROD, sizeof(uint16_t));


/**
 * Element of vendor table.
 */
typedef struct PCIIDDBVENDOR
{
    /** Vendor ID. */
    uint16_t idVendor;
...
AssertCompileSize(PCIIDDBVENDOR, sizeof(uint16_t) * 3);
...
public: // For assertions and statis in the generator.
    ...
    static const PCIIDDBVENDOR   s_aVendors[];
    ...
    static const PCIIDDBPROD     s_aProducts[];
...
#endif /* !MAIN_INCLUDED_PCIIdDatabase_h */
